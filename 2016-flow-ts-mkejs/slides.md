...
* Predictability <!-- .element: class="fragment highlight-red" -->
* Reliability <!-- .element: class="fragment highlight-red" -->
* Refactoring with confidence <!-- .element: class="fragment highlight-red" -->

---

### Containing Complexity Is Hard
...
- What can go wrong? <!-- .element: class="fragment" -->
- Refactoring: user.name <!-- .element: class="fragment" -->
- Modal may require an id <!-- .element: class="fragment" -->
...
<iframe
  src="http://127.0.0.1:4000/try/#"
  width="90%"
  height="800px"
></iframe>
